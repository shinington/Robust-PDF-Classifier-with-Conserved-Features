...
def fitness_01(file_paths, seed_sha1, classifier_name, oracle_name):
    return fitness_pos_neg(file_paths, seed_sha1, classifier_name, oracle_name, offset = 0.0)
...
def fitness_sl2013(file_paths, seed_sha1):
    return fitness_pos_neg(file_paths, seed_sha1, 'sl2013', 'cuckoo')

def fitness_pdfrateR(file_paths, seed_sha1):
    return fitness_01(file_paths, seed_sha1, 'pdfrateR', 'cuckoo')

def fitness_pdfrateB(file_paths, seed_sha1):
    return fitness_01(file_paths, seed_sha1, 'pdfrateB', 'cuckoo')
